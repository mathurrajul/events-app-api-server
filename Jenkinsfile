...
//        e.g https://github.com/mathurrajul/events-app-api-server.git might become https://github.com/MyName/external.git
// variables:
//      https://github.com/mathurrajul/events-app-api-server.git
//      main
//      dtc-102021-u602
//      api-server-image
//      cluster-1 
    ...
    stages {
        stage('Get Source') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/mathurrajul/events-app-api-server.git'
        ...
        stage('Run Tests') {
         ...
         stage('Build and deploy the container') {
            ...
            steps {
                echo "submit gcr.io/dtc-102021-u602/api-server-image:v2.${env.BUILD_ID}"
                sh "gcloud builds submit -t gcr.io/dtc-102021-u602/api-server-image:v2.${env.BUILD_ID} ."
